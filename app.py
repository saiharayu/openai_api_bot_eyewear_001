...
def generate_glasses_image(description, gender):
    ...
    Specifications:
    - Frame style: modern, classic, or vintage
    - Frame material: metal, acetate, titanium, or plastic
    - Frame shape: round, square, rectangular, or rimless
    - Frame color: black, silver, gold, transparent, or tortoiseshell
    - Lenses: clear, no reflection
